...
public class IntStreams2 {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(gen33(9)));
        System.out.println(Arrays.toString(genFibonacchi(300)));
    ...
    public static long[] genFibonacchi(long max) { //Stream — ленивые вычисления
        return Stream.iterate(new long[]{0, 1}, a -> a[0] < max, a -> new long[]{a[1], a[1] + a[0]}) //a0, a1
                .mapToLong(a -> a[0])
                .toArray();
    }
    ...
    public static int[] genPlus() {
        return Stream.iterate(new int[]{1, 1}, a -> a[0] < 100, a -> new int[]{a[0] + a[1], ++a[1]})
                .mapToInt(a -> a[0])
                .toArray();
    }
